...
Если пост должен появиться на странице списка блогов, добавьте его запись в `_data/blog_posts.yml` и укажите ссылку на готовую страницу.
